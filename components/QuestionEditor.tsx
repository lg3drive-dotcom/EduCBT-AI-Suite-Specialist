    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm">
      <div className="bg-white w-full max-w-6xl max-h-[95vh] rounded-2xl shadow-2xl overflow-hidden flex flex-col">
        ...
        <div className="flex-grow overflow-y-auto p-8 space-y-8">
          ...
          <div>
            <label className="block text-[10px] font-black uppercase text-slate-500 mb-2">Analisis Jawaban / Pembahasan</label>
            <textarea rows={3} className="w-full p-4 rounded-xl border border-slate-200 text-sm italic text-slate-600 outline-none bg-amber-50/30" value={edited.explanation} onChange={(e) => setEdited({...edited, explanation: e.target.value})} />
          </div>
        </div>
